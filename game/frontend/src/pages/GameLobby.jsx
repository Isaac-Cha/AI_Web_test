      ...
      <section className="panel p-4 md:p-5 text-sm text-white/80">
        <div className="flex items-start gap-3">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>规则：摸牌 → 办二（摸到 2 可选择办二，同花色 2 成为主花色）→ 翻底定主 → 扣底 6 张 → 上供（副家得分查上供表 0~3 张最大主非分）→ 庄家分配（分配完成立即进庄家与对家手牌）→ 庄家与对家等量还牌（对家花色互不相同）→ 12 轮出牌（可甩牌/杀）→ 翻底 → 结算查上供表 → 准备下一局</li>
            <li>输赢：庄家队 vs 副家队（对家搭档同队）；副家得分小于 35 分庄家胜（庄家不计分也不显示得分）；副家最后一手赢 且 副家队该手至少有 1 张主牌 → 抠底成功（无翻倍），取得 6 张底牌分</li>
          </ul>
        </div>
      </section>
